...
static get rendererdInstasnceId() {
            return MeshComponent.vf32[26 + 116 / 4 * MeshComponent.MEM_CURSOR]
        } 
            
        static set rendererdInstasnceId(v: number) {
            MeshComponent.vf32[26 + 116 / 4 * MeshComponent.MEM_CURSOR] = v;
        }

static get meshId() {
            return MeshComponent.vf32[27 + 116 / 4 * MeshComponent.MEM_CURSOR]
        } 
            
        static set meshId(v: number) {
            MeshComponent.vf32[27 + 116 / 4 * MeshComponent.MEM_CURSOR] = v;
        }

static get _componentId() {
            return MeshComponent.vf32[0 + 116 / 4 * MeshComponent.MEM_CURSOR]
        } 
            
        static set _componentId(v: number) {
            MeshComponent.vf32[0 + 116 / 4 * MeshComponent.MEM_CURSOR] = v;
        }
