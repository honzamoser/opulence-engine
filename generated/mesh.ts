...
export class MeshComponent {
    static STRIDE: number = 40;
    static IDENTIFIER: number = 1;
    static DESCRIPTION: ComponentDescription = {"name":"MeshComponent","stride":40,"importStatement":"import { vec3, Vec3 } from \"wgpu-matrix\";import { constructor, hot } from \"../component-gen\";import { Component } from \"../component\";","properties":[{"byteLength":4,"type":"number","name":"meshId","view":"vf32","default":0,"offset":4},{"byteLength":4,"type":"number","name":"rendererdInstasnceId","view":"vf32","default":0,"offset":8},{"name":"boundingBoxMin","byteLength":12,"arrayLength":3,"type":"Vec3","default":"vec3.create(\r\n    Number.POSITIVE_INFINITY,\r\n    Number.POSITIVE_INFINITY,\r\n    Number.POSITIVE_INFINITY,\r\n  )","view":"vf32","offset":12},{"name":"boundingBoxMax","byteLength":12,"arrayLength":3,"type":"Vec3","default":"vec3.create(\r\n    Number.NEGATIVE_INFINITY,\r\n    Number.NEGATIVE_INFINITY,\r\n    Number.NEGATIVE_INFINITY,\r\n  )","view":"vf32","offset":24},{"name":"_componentId","byteLength":4,"offset":0,"type":"number","default":"0"}]}
...
const base = MeshComponent.MEM_CURSOR * 40;
...
static get meshId() {
            return MeshComponent.vf32[1 + 40 * MeshComponent.MEM_CURSOR]
        } 
            
        static set meshId(v: number) {
            MeshComponent.vf32[1 + 40 * MeshComponent.MEM_CURSOR] = v;
        }

static get rendererdInstasnceId() {
            return MeshComponent.vf32[2 + 40 * MeshComponent.MEM_CURSOR]
        } 
            
        static set rendererdInstasnceId(v: number) {
            MeshComponent.vf32[2 + 40 * MeshComponent.MEM_CURSOR] = v;
        }

static get boundingBoxMin() {
            return MeshComponent.vf32.subarray((12 / 4) + (40 / 4) * MeshComponent.MEM_CURSOR, (12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 3)
    }
            
    static set boundingBoxMin(v: Vec3 | Float32Array) {
        MeshComponent.vf32.set(v, (12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR);
    }
        
    static cpy_boundingBoxMin(out: Vec3) {
        out.set(MeshComponent.vf32.subarray((12 / 4) + (40 / 4) * MeshComponent.MEM_CURSOR, (12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 3));
    }
        
    static get boundingBoxMinX() {
        return MeshComponent.vf32[(12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 0];
    }

    static set boundingBoxMinX(v: number) {
        MeshComponent.vf32[(12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 0] = v;
    }
static get boundingBoxMinY() {
        return MeshComponent.vf32[(12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 1];
    }

    static set boundingBoxMinY(v: number) {
        MeshComponent.vf32[(12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 1] = v;
    }
static get boundingBoxMinZ() {
        return MeshComponent.vf32[(12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 2];
    }

    static set boundingBoxMinZ(v: number) {
        MeshComponent.vf32[(12 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 2] = v;
    }

static get boundingBoxMax() {
            return MeshComponent.vf32.subarray((24 / 4) + (40 / 4) * MeshComponent.MEM_CURSOR, (24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 3)
    }
            
    static set boundingBoxMax(v: Vec3 | Float32Array) {
        MeshComponent.vf32.set(v, (24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR);
    }
        
    static cpy_boundingBoxMax(out: Vec3) {
        out.set(MeshComponent.vf32.subarray((24 / 4) + (40 / 4) * MeshComponent.MEM_CURSOR, (24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 3));
    }
        
    static get boundingBoxMaxX() {
        return MeshComponent.vf32[(24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 0];
    }

    static set boundingBoxMaxX(v: number) {
        MeshComponent.vf32[(24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 0] = v;
    }
static get boundingBoxMaxY() {
        return MeshComponent.vf32[(24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 1];
    }

    static set boundingBoxMaxY(v: number) {
        MeshComponent.vf32[(24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 1] = v;
    }
static get boundingBoxMaxZ() {
        return MeshComponent.vf32[(24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 2];
    }

    static set boundingBoxMaxZ(v: number) {
        MeshComponent.vf32[(24 / 4) + 40 / 4 * MeshComponent.MEM_CURSOR + 2] = v;
    }

static get _componentId() {
            return MeshComponent.vf32[0 + 40 * MeshComponent.MEM_CURSOR]
        } 
            
        static set _componentId(v: number) {
            MeshComponent.vf32[0 + 40 * MeshComponent.MEM_CURSOR] = v;
        }
