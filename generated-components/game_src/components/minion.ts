...
export default class MinionComponent extends Component {
    ...
    protected ECS: ECS;
  @hot.float32Array(3)
  private _targetLocation: Vec3 | null = null;
  @hot.float32
  private _speed: number = 0.005;
    ...
    get targetLocation(): Vec3 | null {
        return this.ECS.getComponentValue(this.index, this, "targetLocation");
    }

    set targetLocation(value: Vec3 | null) {
        this.ECS.setComponentValue(this.index, this, "targetLocation", value)
    }
